...
#	while inputFileName:
#		byte = inputFile.read(chunk_size)
#		content += byte
...
#	inputFileContent = content
	...
	#by this code we can add new meta data
	h["X-Object-Meta-Owner1"] = request.form['OwnerName1']   
	

	swift.createObject(inputFileName,inputFile,folderName,h,10)
